...
PASSWORD_CREATE_USER = os.environ.get('PASSWORD_CREATE_USER')
TOKEN_ADMIN_MATTERMOST = os.environ.get('TOKEN_ADMIN_MATTERMOST')
TEAM_ID = os.environ.get('TEAM_ID')
MATTER_MOST_URL = os.environ.get('MATTER_MOST_URL')

# Create user


def create_user(user_id):
    print(MATTER_MOST_URL)
    req_data = {
...
def get_user_detail(user_id):
    end_point = 'users/{}'.format(user_id)
    req_url = '{}/{}'.format(MATTER_MOST_URL, end_point)
    print(req_url)
    req_headers = {
        'Content-Type': 'application/json',
